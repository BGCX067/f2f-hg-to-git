...
#define FloatType co_int32
#define DoubleType co_int32
...
//#define multiply(a, b)        (FXMUL32(a, b, FRACBITS))
//#define divide(a, b)          (FXDIV32(a, b, FRACBITS))
...
/**** GENERAL ARITHMETIC *************************/
#define add(a, b)             ((a) + (b))
//#define add(a, b)             (FXADD32(a, b, FRACBITS))
#define add3(a, b, c)         (add(a, add(b, c)))
#define sub(a, b)             ((a) - (b))
//#define sub(a, b)             (FXSUB32(a, b, FRACBITS))
#define multiply3(a, b, c)    (multiply(multiply((a), (b)), (c)))
#define assign_add(v, x)      (v += (x))
//#define assign_add(v, x)      (v = add(v, x))
#define assign_sub(v, x)      (v -= (x))
//#define assign_sub(v, x)      (v = sub(v, x))
